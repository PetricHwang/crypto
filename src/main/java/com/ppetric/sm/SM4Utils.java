...
public class SM4Utils extends GMBaseUtil {
    ...
    public static void main(String[] args) throws DecoderException, NoSuchPaddingException, NoSuchAlgorithmException,
        ...
        byte[] enc = encryptECBPadding(Hex.decodeHex(hexKey), hexData.getBytes());
